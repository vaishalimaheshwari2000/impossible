...
export const Tictac = () => {
   ...
   let box_array = [box1,box2,box3,box4,box5,box6,box7,box8,box9];
    ...
    if(lock) {
      ...
      const won = (winner)=> {
        ...
        setLock(true);
        if(winner==="x"){
            titleRef.current.innerHTML = `Congratulations : <img className="win" src= '${cross}'></img>` 
        }
        else
        if(winner==="o"){
            titleRef.current.innerHTML = `Congratulations : <img src= '${circle}'></img>` 
        }
    } 
  ...
  return (
    <div className='container'>  
      <h1 className='tic' ref={titleRef}>Tic Tac Toe <span>Game</span></h1>
    ...
    <div className='board'>
     ...
     <button className='reset'  onClick={() => press() }><span>Reset</span></button>
    </div>
